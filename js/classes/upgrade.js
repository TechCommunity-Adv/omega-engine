...
const RESOURCE_ALEPH = 0, RESOURCE_LAYERCOINS = 1, RESOURCE_ALEPH_FR = 2;
...
class AlephUpgradeFrance extends ResourceUpgrade
{
    constructor(description, getPrice, getEffect, cfg)
    {
        super(description, getPrice, getEffect, RESOURCE_ALEPH_FR, cfg);
    }
}
